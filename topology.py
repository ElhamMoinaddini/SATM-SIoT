...
class Topology:
    ...
    def __init_uptimes(self):
        ...
        #print("data=================",self.nodeAttributes)    
    def get_edges(self):
        """
        Returns:
    ...
    def create_link_event(self,id_node1, id_node2):
        print("link is added")
        self.G.add_edge(id_node1, id_node2)

    # Define an event that deletes the link between the two nodes after 10 simulation units
    def delete_link_event(self,id_node1, id_node2):
        self.G.remove_edge(id_node1, id_node2)
